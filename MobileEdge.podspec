#
#  Be sure to run `pod spec lint MobileEdge.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.homepage     = "http://EXAMPLE/MobileEdge"
  ...
  s.source       = { :git => "http://EXAMPLE/MobileEdge.git", :tag => "0.0.1" }
