...
- (NSString *)javascriptInjection {
    ...
    Byte uaspoof = [[((MOBTorSettings *)appDelegate.mobileEdgeCore.anonymizer.settings).settings valueForKey:@"uaspoof"] integerValue];
    ...
    Byte activeContent = [[((MOBTorSettings *)appDelegate.mobileEdgeCore.anonymizer.settings).settings valueForKey:@"javascript"] integerValue];
